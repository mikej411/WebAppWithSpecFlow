...
namespace Browser.Core.Framework
{
	...
	public abstract class BrowserTest
    {
        ...
        {
            return string.Format("EndTest << {0} - {1} - {2}", context.Result.Outcome.Status, elapsedTime, GetDriverCountMessage());
        }
        ...
        protected T GetContextProperty<T>(string propertyName, Func<object, T> converter = null)
        {
            ...
            if (CurrentContext.Test.Properties.Keys.Contains(propertyName))
            ...
            if (FixtureContext.Test.Properties.Keys.Contains(propertyName))
